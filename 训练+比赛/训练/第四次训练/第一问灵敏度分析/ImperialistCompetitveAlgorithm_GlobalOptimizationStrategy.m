function [target_val, target_co]=ImperialistCompetitveAlgorithm_GlobalOptimizationStrategy()
global dots
global dismat
global path_var
load dots
...
target_val=MinimumCost(end);
target_co = Empires(1).ImperialistPosition;