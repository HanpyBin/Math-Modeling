function Empires = CreateInitialEmpires(InitialCountries,InitialCost,AlgorithmParams, ProblemParams, InitialOrds)
...
AllImperialistsOrds = InitialOrds(1:AlgorithmParams.NumOfInitialImperialists,:);
...
AllColoniesOrds = InitialOrds(AlgorithmParams.NumOfInitialImperialists+1:end,:);
...
for ii = 1:AlgorithmParams.NumOfInitialImperialists
    ...
    Empires(ii).ImperialistOrds = AllImperialistsOrds(ii,:);
    ...
    Empires(ii).ColoniesOrds = AllColoniesOrds(R,:);
